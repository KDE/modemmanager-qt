...
#ifndef MODEMMANAGERQT_MODEMGSMHSOINTERFACE_P_H
#define MODEMMANAGERQT_MODEMGSMHSOINTERFACE_P_H
...
{
public:
    ModemGsmHsoInterfacePrivate(const QString &path, QObject *owner);
