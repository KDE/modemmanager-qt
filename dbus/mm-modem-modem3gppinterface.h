...
#ifndef MM-MODEM-MODEM3GPPINTERFACE_H_1370342306
#define MM-MODEM-MODEM3GPPINTERFACE_H_1370342306
...
namespace org {
  namespace freedesktop {
    namespace ModemManager1 {
      namespace Modem {
        typedef ::OrgFreedesktopModemManager1ModemModem3gppInterface Modem3gpp;
      }
    }
  }
}
