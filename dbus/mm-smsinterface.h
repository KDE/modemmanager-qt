 ...
 * Command line was: qdbusxml2cpp -m introspection/org.freedesktop.ModemManager1.Sms.xml -p mm-smsinterface
 *
...
#ifndef MM-SMSINTERFACE_H_1370342401
#define MM-SMSINTERFACE_H_1370342401
...
public:
    ...
    Q_PROPERTY(uint Validity READ validity)
    inline uint validity() const
    { return qvariant_cast< uint >(property("Validity")); }
...
namespace org {
  namespace freedesktop {
    namespace ModemManager1 {
      typedef ::OrgFreedesktopModemManager1SmsInterface Sms;
    }
  }
}
#endif
