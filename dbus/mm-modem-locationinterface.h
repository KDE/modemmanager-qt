 ...
 * Command line was: qdbusxml2cpp -m -p mm-modem-locationinterface /home/ilia/libnm-qt/solid/modemmanager-0.4/dbus/introspection/mm-modem-location.xml
 *
...
public:
    ...
    Q_PROPERTY(ModemManager::ModemLocationInterface::LocationInformationMap Location READ location)
    inline ModemManager::ModemLocationInterface::LocationInformationMap location() const
    { return qvariant_cast< ModemManager::ModemLocationInterface::LocationInformationMap >(property("Location")); }
...
public Q_SLOTS: // METHODS
    ...
    inline QDBusPendingReply<ModemManager::ModemLocationInterface::LocationInformationMap> GetLocation()
    {
        QList<QVariant> argumentList;
