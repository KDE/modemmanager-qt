...
#ifndef MODEMMANAGERQT_MODEMGSMCONTACTSINTERFACE_P_H
#define MODEMMANAGERQT_MODEMGSMCONTACTSINTERFACE_P_H
...
{
public:
    ModemGsmContactsInterfacePrivate(const QString &path, QObject *owner);
