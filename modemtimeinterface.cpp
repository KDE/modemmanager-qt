...
ModemTimeInterfacePrivate::ModemTimeInterfacePrivate(const QString &path, QObject *owner)
    : ModemInterfacePrivate(path, owner),
      modemTimeIface(MM_DBUS_SERVICE, path, QDBusConnection::systemBus(), this)
{
}

ModemManager::ModemTimeInterface::ModemTimeInterface(const QString & path, QObject * parent)
    : ModemInterface(*new ModemTimeInterfacePrivate(path, this), parent)
{
