...
public:
     ...
     *
     * \a carrierCode name of carrier, or carrier-specific code
     */
     ...
     * Some modems will reboot after this call is made.
     *
     * \a properties QVariantMap consisting of:
     *
     ...
     * \sa http://ifast.org or the mobile broadband provider database for mappings of SIDs to network providers.
     */
    uint sid() const;
