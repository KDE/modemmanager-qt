 ...
 *
 * \inheaderfile ModemManager::Sms
 *
 * \inmodule ModemManagerQt
 *
 * \brief Provides an interface to manipulate and control an SMS.
 *
 * \note MMSmsStorage, MMSmsState, MMSmsPduType and MMSmsDeliveryState enums are defined in <ModemManager/ModemManager-enums.h>
...
public:
     ...
     * Store the SMS
     *
     * \a storage the storage location of the SMS (empty for default storage)
     */
    ...
    /*!
     * Returns \c true if a delivery report is requested, \c false otherwise
     */
    ...
    /*!
     * Returns teleservice IDs supported for CDMA SMS, as defined in 3GPP2 X.S0004-550-E
